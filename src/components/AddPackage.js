        ...
        <table style={{ width: '95%' }}> 
          <tbody>
            <tr>
              ...
              <td>
                <div className={classnames({ 'has-danger': !this.props.package.get('isValid')})}>
                <input type="text" 
                    name="package" 
                ...
                {!this.props.package.get('isValid') && <div className="alert alert-danger">This does not appear to be a valid package.</div>}
