  ...
  render: function() {
    return <div className="col-xs-12 col-sm-4 col-lg-2 package">
      ...
      {this.props.loading.get('deleting') !== this.props.data.get('_id') && <div>
          <h5 style={{ display: 'inline' }}><a href="Javascript: void();" onClick={() => this.remove()}><i className="fa fa-times"></i></a> <a href="Javascript: void(0);" onClick={() => this.toggleEdit()}><i className="fa fa-pencil"></i></a></h5>
